      ...
      <div class="seq-preloader">
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="#3"><i class="fa fa-book"></i> <em>Resume</em></a></li>
            <li><a href="#4"><i class="fa fa-institution"></i> <em>Skill</em></a></li>
            <li><a href="#4"><i class="fa fa-toggle-on"></i> <em>Project</em></a></li>
            ...
            <div class="content first-content">
              <div class="container-fluid">
                  <div class="col-md-3">
                      ...
                      <div class="author-image"><img src="img/mypic.png" alt=""></div>
                  </div>
                  <div class="col-md-9">
                      <h2>SHERIFFDEEN, ADIGUN FASASI</h2>
                      <p>I'm an experienced <em> software engineer</em>, who constantly seeks out <em>innovative solutions</em> to everyday problems. In my years in this industry, I've honed my analytical thinking and collaboration skills, and I love working with a team. I also have years of experience in the <em>financial institutions in Nigeria.</em></p>
                      <div class="main-btn"><a href="#2">Read More</a></div>
                      <div class="fb-btn"><a href="https://www.linkedin.com/in/sheriffdeen-fasasi-244500158/" target="_blank">My Linkedin Profile</a></div>
                  </div>
              </div>
            </div>
          </div>
